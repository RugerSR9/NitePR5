...
| 2026-08-26 | Overlay 0.53: PROC_ELF hijacks a game thread; that thread must RET (0.52 ran CRT/`for(;;)` on it → boot freeze and no alive file). Entry spawns a pthread then returns. Plugin injects ~12 s after title appear. |
